/*
Template Name: NikiLaPOL - Admin & Dashboard Template
Author: NusantaraKu
Version: 3.3.0.
Website: https://NusantaraKu.com/
Contact: NusantaraKu@gmail.com
File: Main Js File
*/
    ...
    function updateThemeSetting(id) {
        if (
            ...
            $("#bootstrap-style").attr(
                "href",
                "/asset/backend/css/bootstrap.min.css"
            );
            $("#app-style").attr("href", "/asset/backend/css/app.min.css");
            sessionStorage.setItem("is_visited", "light-mode-switch");
        } else if (
            ...
            $("#bootstrap-style").attr(
                "href",
                "/asset/backend/css/bootstrap-dark.min.css"
            );
            $("#app-style").attr("href", "/asset/backend/css/app-dark.min.css");
            ...
            $("#bootstrap-style").attr(
                "href",
                "/asset/backend/css/bootstrap.rtl.css"
            );
            $("#app-style").attr("href", "/asset/backend/css/app.rtl.css");
            $("html").attr("dir", "rtl");
            ...
            $("#bootstrap-style").attr(
                "href",
                "/asset/backend/css/bootstrap-dark.rtl.css"
            );
            $("#app-style").attr("href", "/asset/backend/css/app-dark.rtl.css");
            $("html").attr("dir", "rtl");
