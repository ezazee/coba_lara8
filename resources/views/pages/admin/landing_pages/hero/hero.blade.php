    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                ...
                <h4 class="card-title mb-2">Hero Section</h4>
                    ...
                    <table class="table align-middle table-nowrap mb-0">
                        <thead class="table-light">
                            <tr>
                                ...
                                <th class="align-middle">Link GooglePlay</th>
                                <th class="align-middle">Gambar Banner</th>
                                <th class="align-middle">Gambar HP</th>
