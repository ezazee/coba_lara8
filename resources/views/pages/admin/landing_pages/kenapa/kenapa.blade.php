...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title mb-4">Why Section</h4>
                    ...
                    <table class="table align-middle table-nowrap mb-0">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>Kenapa Harus Nyaku Bitung</td>
                                <td>Portofolio Produk Daerah</td>
                                ...
                                <td>
                                    ...
                                    <a href="/admin/kenapa/edit" type="button" class="btn btn-primary waves-effect btn-label waves-light btn-sm"><i class="bx bx-edit  label-icon"></i> Edit</a>
                                </td>
                            </tr>
                        </tbody>
                    </table>
