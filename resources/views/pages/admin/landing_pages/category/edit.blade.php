...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title mb-4">Konfigurasi Category Layanan</h4>
                    <form action="" method="POST" enctype="multipart/form-data">
                        <div class="row mb-4">
                            <label for="title" class="col-form-label col-lg-2">Title</label>
                            <div class="col-lg-10">
                                <input id="title" name="title" type="text" class="form-control"
                                    placeholder="Enter Project Name..." value="Category Layanan" >
                            </div>
                        </div>
                        <div class="row mb-4">
                       ...
                       <div class="row mb-4">
                            <label for="youtube" class="col-form-label col-lg-2">Link To WebComerse</label>
                            <div class="col-lg-10">
                            <input id="youtube" name="youtube" type="text" class="form-control"
                                    placeholder="Masukan link Web" value="" >
                            </div>
                        </div>
