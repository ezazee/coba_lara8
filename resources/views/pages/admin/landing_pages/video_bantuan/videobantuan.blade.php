    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                ...
                <h4 class="card-title mb-2">List Video</h4>
                <div class="d-flex flex-wrap mb-2">
                    <a href="/admin/video_bantuan/create" type="button" class="btn btn-success waves-effect btn-label waves-light mb-2"><i class="bx bx-add-to-queue label-icon"></i>Tambah Data</a>
                </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form action="" method="POST">
                                        <a class="btn btn-primary waves-effect btn-label waves-light btn-sm" href="/admin/video_bantuan/edit"><i class="bx bx-edit  label-icon"></i>Edit</a>
