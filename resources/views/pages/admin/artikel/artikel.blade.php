        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="d-flex flex-wrap mb-2">
                    <a href="/admin/artikel/create" type="button" class="btn btn-success waves-effect btn-label waves-light mb-2"><i class="bx bx-add-to-queue label-icon"></i>Tambah Data</a>
                </div>
                    ...
                    <table class="table align-middle table-nowrap mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="width: 100px;"><img src="" alt="" class="avatar-md h-auto d-block rounded"></td>
                                <td>
                                ...
                                <td>
                                    <form action="" method="POST">
                                        <a class="btn btn-primary waves-effect btn-label waves-light btn-sm" href="/admin/artikel/edit"><i class="bx bx-edit  label-icon"></i>Edit</a>
